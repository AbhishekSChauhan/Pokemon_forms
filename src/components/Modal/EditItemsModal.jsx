...
const EditItemsModal = ({
  ...
  return (
    ...
    >
      <Box className='bg-gray-100 mt-16 sm:mt-28 p-4 md:p-10 mx-auto flex flex-col text-center 
        ...
        <div className="p-4 font-bold text-left relative">
          Cost
          <span className="absolute right-6 sm:right-7 font-semibold">${cartTotal}</span>
        </div>
